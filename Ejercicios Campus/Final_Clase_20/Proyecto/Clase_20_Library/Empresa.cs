...
namespace Clase_8_Library
{
    public class Empresa : ISerializable<string>
    {
        ...
        {
            return this.guardar(archivo, this.MostrarEmpresa(), false);
        }
        ...
        {
            return this.guardar(archivo, this.MostrarEmpresa(), true);
        }
        ...
        private bool guardar(string archivo, string datos, bool agregarAlFinal)
        {
            try
            {
                using (System.IO.StreamWriter file = new System.IO.StreamWriter(archivo, agregarAlFinal))
                {
