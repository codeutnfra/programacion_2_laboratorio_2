...
{
    public class Concecionaria // Colocar abstract
    {
        ...
        /// <returns></returns>
        public static string Mostrar(Concecionaria concecionaria, ETipo tipoDeVehiculo) //quitar static
        {
            ...
            foreach (Vehiculo v in concecionaria._vehiculos)
            {
                switch (tipoDeVehiculo)
                {
                    case ETipo.Automovil:
                        if(v is Automovil) // Quitar IF
                            sb.AppendLine(v.Mostrar());
                        break;
                    case ETipo.Moto:
                        if (v is Moto) // Quitar IF
                            sb.AppendLine(v.Mostrar());
                        break;
                    case ETipo.Camion:
                        if (v is Camion) // Quitar IF
                            sb.AppendLine(v.Mostrar());
                        break;
                    default:
                        sb.AppendLine(v.Mostrar());
        ...
        #region "Operadores"
        /// <summary>
        /// Agregará un vehículo a la concecionaria
        /// </summary>
        ...
        public static Concecionaria operator +(Concecionaria concecionaria, Vehiculo vehiculo)
        {
            ...
            foreach (Vehiculo v in concecionaria._vehiculos) //quitar lista
            {
                if (v == vehiculo)
                    return concecionaria;
            }
